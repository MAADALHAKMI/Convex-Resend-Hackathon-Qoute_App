 ...
 */
export declare function customCtx<InCtx extends Record<string, any>, OutCtx extends Record<string, any>, ExtraArgs extends Record<string, any> = Record<string, any>>(mod: (original: InCtx, extra: ExtraArgs) => Promise<OutCtx> | OutCtx): Customization<InCtx, Record<string, never>, OutCtx, Record<string, never>, ExtraArgs>;
/**
