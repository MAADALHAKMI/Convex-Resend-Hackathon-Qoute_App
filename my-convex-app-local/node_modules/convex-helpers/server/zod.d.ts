 ...
 */
export type ZCustomCtx<Builder> = Builder extends CustomBuilder<any, any, infer CustomCtx, any, infer InputCtx, any> ? Overwrite<InputCtx, CustomCtx> : never;
/**
 ...
 */
export declare function zCustomQuery<CustomArgsValidator extends PropertyValidators, CustomCtx extends Record<string, any>, CustomMadeArgs extends Record<string, any>, Visibility extends FunctionVisibility, DataModel extends GenericDataModel>(query: QueryBuilder<DataModel, Visibility>, customization: Customization<GenericQueryCtx<DataModel>, CustomArgsValidator, CustomCtx, CustomMadeArgs>): CustomBuilder<"query", CustomArgsValidator, CustomCtx, CustomMadeArgs, GenericQueryCtx<DataModel>, Visibility>;
/**
 ...
 */
export declare function zCustomMutation<CustomArgsValidator extends PropertyValidators, CustomCtx extends Record<string, any>, CustomMadeArgs extends Record<string, any>, Visibility extends FunctionVisibility, DataModel extends GenericDataModel>(mutation: MutationBuilder<DataModel, Visibility>, customization: Customization<GenericMutationCtx<DataModel>, CustomArgsValidator, CustomCtx, CustomMadeArgs>): CustomBuilder<"mutation", CustomArgsValidator, CustomCtx, CustomMadeArgs, GenericMutationCtx<DataModel>, Visibility>;
/**
 ...
 */
export declare function zCustomAction<CustomArgsValidator extends PropertyValidators, CustomCtx extends Record<string, any>, CustomMadeArgs extends Record<string, any>, Visibility extends FunctionVisibility, DataModel extends GenericDataModel>(action: ActionBuilder<DataModel, Visibility>, customization: Customization<GenericActionCtx<DataModel>, CustomArgsValidator, CustomCtx, CustomMadeArgs>): CustomBuilder<"action", CustomArgsValidator, CustomCtx, CustomMadeArgs, GenericActionCtx<DataModel>, Visibility>;
type OneArgArray<ArgsObject extends DefaultFunctionArgs = DefaultFunctionArgs> = [
    ArgsObject
];
export type ArgsArray = OneArgArray | [];
export type ReturnValueForOptionalZodValidator<ReturnsValidator extends z.ZodTypeAny | ZodValidator | void> = [ReturnsValidator] extends [z.ZodTypeAny] ? z.input<ReturnsValidator> | Promise<z.input<ReturnsValidator>> : [ReturnsValidator] extends [ZodValidator] ? z.input<z.ZodObject<ReturnsValidator>> | Promise<z.input<z.ZodObject<ReturnsValidator>>> : any;
export type OutputValueForOptionalZodValidator<ReturnsValidator extends z.ZodTypeAny | ZodValidator | void> = [ReturnsValidator] extends [z.ZodTypeAny] ? z.output<ReturnsValidator> | Promise<z.output<ReturnsValidator>> : [ReturnsValidator] extends [ZodValidator] ? z.output<z.ZodObject<ReturnsValidator>> | Promise<z.output<z.ZodObject<ReturnsValidator>>> : any;
export type ArgsArrayForOptionalValidator<ArgsValidator extends ZodValidator | z.ZodObject<any> | void> = [ArgsValidator] extends [ZodValidator] ? [z.output<z.ZodObject<ArgsValidator>>] : [ArgsValidator] extends [z.ZodObject<any>] ? [z.output<ArgsValidator>] : ArgsArray;
export type DefaultArgsForOptionalValidator<ArgsValidator extends ZodValidator | z.ZodObject<any> | void> = [ArgsValidator] extends [ZodValidator] ? [z.output<z.ZodObject<ArgsValidator>>] : [ArgsValidator] extends [z.ZodObject<any>] ? [z.output<ArgsValidator>] : OneArgArray;
 ...
 */
export type CustomBuilder<FuncType extends "query" | "mutation" | "action", CustomArgsValidator extends PropertyValidators, CustomCtx extends Record<string, any>, CustomMadeArgs extends Record<string, any>, InputCtx, Visibility extends FunctionVisibility> = {
    <ArgsValidator extends ZodValidator | z.ZodObject<any> | void, ReturnsZodValidator extends z.ZodTypeAny | ZodValidator | void = void, ReturnValue extends ReturnValueForOptionalZodValidator<ReturnsZodValidator> = any, OneOrZeroArgs extends ArgsArrayForOptionalValidator<ArgsValidator> = DefaultArgsForOptionalValidator<ArgsValidator>>(func: ({
        /**
         * Specify the arguments to the function as a Zod validator.
         */
        args?: ArgsValidator;
        handler: (ctx: Overwrite<InputCtx, CustomCtx>, ...args: OneOrZeroArgs extends [infer A] ? [Expand<A & CustomMadeArgs>] : [CustomMadeArgs]) => ReturnValue;
        /**
        ...
        (ctx: Overwrite<InputCtx, CustomCtx>, ...args: OneOrZeroArgs extends [infer A] ? [Expand<A & CustomMadeArgs>] : [CustomMadeArgs]): ReturnValue;
    }): Registration<FuncType, Visibility, ArgsArrayToObject<[
        ArgsValidator
    ] extends [ZodValidator] ? [
        Expand<z.input<z.ZodObject<ArgsValidator>> & ObjectType<CustomArgsValidator>>
    ] : [ArgsValidator] extends [z.ZodObject<any>] ? [Expand<z.input<ArgsValidator> & ObjectType<CustomArgsValidator>>] : OneOrZeroArgs extends [infer A] ? [Expand<A & ObjectType<CustomArgsValidator>>] : [ObjectType<CustomArgsValidator>]>, ReturnsZodValidator extends void ? ReturnValue : OutputValueForOptionalZodValidator<ReturnsZodValidator>>;
};
...
}, "strip"> : V extends VRecord<any, infer Key, infer Value, any, any> ? Key extends VId<GenericId<infer TableName>> ? z.ZodRecord<Zid<TableName>, ZodValidatorFromConvex<Value>> : z.ZodRecord<z.ZodString, ZodValidatorFromConvex<Value>> : V extends VArray<any, any> ? z.ZodArray<ZodValidatorFromConvex<V["element"]>> : V extends VUnion<any, any, any, any> ? z.ZodUnion<[
