import { type Expand, type FunctionReference, type FunctionVisibility } from "convex/server";
...
import { type EmailEvent, type RunMutationCtx, type RunQueryCtx } from "../component/shared.js";
...
export declare class Resend {
     ...
     */
    defineOnEmailEvent(handler: (ctx: RunMutationCtx, args: {
        id: EmailId;
        event: EmailEvent;
    }) => Promise<void>): Promise<import("convex/server").RegisteredMutation<"internal", {
        id: EmailId;
        event: EmailEvent;
    }, Promise<void>>>;
}
