...
import { C as ClampedIntegerSubtract } from './ClampedIntegerSubtract-DdO1KLSt.js';
 ...
 */
type ArrayAt<T extends IterableContainer, I extends keyof T> = If<IsNumericLiteral<I>, I extends unknown ? [
    ...TupleParts<T>["required"],
    ...TupleParts<T>["optional"]
] extends infer Prefix extends ReadonlyArray<unknown> ? If<HasIndex<Prefix, I>, T[I], TupleParts<T>["item"] | (ClampedIntegerSubtract<I, Prefix["length"]> extends infer SuffixIndex extends number ? If<HasIndex<TupleParts<T>["suffix"], SuffixIndex>, TupleParts<T>["suffix"][IntRangeInclusive<0, SuffixIndex>], TupleParts<T>["suffix"][number] | undefined> : never)> : never : never, T[number] | undefined>;
